...
const experiences: Experience[] = [
  {
    ...
    description: [
      ...
      'Resolved race conditions in the event registration system using database locks to ensure atomicity and prevent duplicate records.',
  ...
  },
  {
    ...
    current: false,
    description: [
      'Developed a responsive landing page focused on performance, SEO, and patient conversion.',
      'Built a tattoo artist website with a custom CMS for portfolio and content management, including authentication and access control.',
      'Led the full project lifecycle — from requirements gathering and design through development and client delivery.',
    ],
