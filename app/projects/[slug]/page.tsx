...
const ProjectPage = async ({
  ...
  return (
    <main className="w-full space-y-8">
      ...
      />
      <section
        className={`prose prose-li:text-muted-foreground prose-p:text-muted-foreground prose-h1:text-accent-foreground prose-strong:text-accent-foreground prose-h2:text-accent-foreground prose-h3:text-accent-foreground prose-a:text-accent-foreground`}
      >
        {project.markdown}
      </section>
    </main>
